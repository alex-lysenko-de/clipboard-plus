...
InitMyGui(*) {
    ...
    MyGui.Add("Edit", "xm y+5 w500 h250 VScroll HScroll ReadOnly vMemoField", "OCR text will appear here...")

    ; Button "Ok"
    btnOk := MyGui.Add("Button", "Default xm y+20 w100 h30", "Ok")
    btnOk.OnEvent("Click", ButtonOk_Click)
